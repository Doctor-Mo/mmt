  ...
  class CollectionDraftProposalsController < CollectionDraftsController
    ...
    def approve
      ...
      if get_resource.approve && get_resource.save
        ...
        # User e-mail
        ProposalMailer.proposal_approved_notification(submitter_from_resource_response, get_resource.draft['ShortName'], get_resource.draft['Version'], params['id']).deliver_now if submitter_from_resource_response
        # Approver e-mail
